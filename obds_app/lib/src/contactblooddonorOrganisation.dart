...
class ContactBloodDonorOrg extends StatefulWidget
{
  String organizationid;
  ContactBloodDonorOrg(this.organizationid);
   @override
  ContactBloodDonorOrgState createState() => ContactBloodDonorOrgState(organizationid);
 
}
class ContactBloodDonorOrgState extends State<ContactBloodDonorOrg>
{
  String organizationid;
  ContactBloodDonorOrgState(this.organizationid);
    ...
    var row;
     var db = new Mysql();
      await db.getConnection().then((conn)  async{
        String sql = "select Name,Age,Blood_Group,Contact,Address,pincode from Blood_Donor where ORG_id=\"$organizationid\";"; 
