...
class ContactMBG extends StatefulWidget
{
  String organisationid;
  ContactMBG(this.organisationid);
  @override
  ContactMBGState createState() => ContactMBGState(organisationid);

}
class ContactMBGState extends State<ContactMBG>
{
  String organisationid;
  ContactMBGState(this.organisationid);
  ...
  void getdata() async {
    ...
    await db.getConnection().then((conn)  async{
      ...
      String sql = "select A.Name, A.Contact, A.Address from Organisation as A Where A.ORG_id in (Select ORG_id from Blood_Donor Where BLD_id = \'"+organisationid+"\');";
